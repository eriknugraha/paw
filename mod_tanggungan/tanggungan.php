...
?>
	<section>
		<ul class="breadcrumb" style="margin-bottom: 5px;">
			<li class="active">Data Non-Member</li>
			
		</ul>
		<?php if (($_SESSION['akses']=="3")||($_SESSION['akses']=="1")){ ?>
		<div class="control-group pull-left">
			<button class="btn btn-primary" type="button" onclick="window.location='media.php?module=tanggungan&&act=tambah'"><i class="icon-plus icon-white"></i> Tambah Non-member</button>
		</div><?php }?>
		...
		<div class="row-fluid">
			...
			<div id="hasil"></div>
				...
				<table class="table table-striped">
					...
					<tbody>
					<?php					
					$query=mysql_query("SELECT * FROM tmember where status ='non-member' ORDER BY nama_member ASC LIMIT $posisi,$batas");
					$no=$posisi+1;
						...
						<tr >
                            ...
                            <td><div class="btn-group">
								...
								<ul class="dropdown-menu">
									...
									<li><a href="media.php?module=tanggungan&&act=edit&&kodepasien=<?php echo $r['id_member']; ?>"><i class="icon-pencil"></i> Edit</a></li>
					...
					<tr>
							<td colspan="7">
							<?php
							$jmldata=mysql_num_rows(mysql_query("SELECT * FROM tmember where status ='non-member'"));
...
$nounik = $th_sekarang.sprintf('%06s', $NoUrut++);
	?>
		<section>
		<ul class="breadcrumb" style="margin-bottom: 5px;">
			<li><a href="media.php?module=tanggungan">Data Non-Member</a> <span class="divider"><b>&gt;</b></span></li>
			<li class="active">Tambah Non-Member</li>
		</ul>
		...
		<div class="row-fluid">
			<div class="span12 pull-left">
				...
				<fieldset>
				<legend class="span7 offset1">Tambah Non-Member</legend>
				<div class="clear"></div>
				...
				<div class="span3">							
							<div class="control-group">
								...
								<div class="controls">
								<input type="date" id="inputText"  class="span10" name="t4" required>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="inputPassword">Tanggal Lahir</label>
								<div class="controls">
								<input type="date" id="tgl"  class="span10" name="t5" required>
								</div>
							</div>
							...
							<!-- <div class="control-group">
								...
								<div class="controls">
								<input type="date" id="inputText"  class="span10" name="t11" required>
								</div>
							</div> -->		
								<div class="control-group">
								<label class="control-label" for="inputPassword">Status</label>
								<div class="controls">
								<input type="date" id="inputText"  class="span10" name="t12" value="non-member" readonly>
								</div>
							</div>	
							</fieldset>
						</form>	
...
?>
	<section>
		<ul class="breadcrumb" style="margin-bottom: 5px;">
			<li><a href="media.php?module=tanggungan">Data Non-Member</a> <span class="divider"><b>&gt;</b></span></li>
			<li class="active">Update Non-Member</li>
		</ul>
				...
				<div class="span3">							
							...
							<div class="control-group">
							  ...
							  <?php
								...
								$photo= $r['photo'];
							if($photo!=''){
                              echo "<img src='foto_pasien/$photo' style='width:150px;height:150px' >";
                              }
                             else{
